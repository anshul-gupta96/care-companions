...
document.getElementById('about-us-link').addEventListener('click', function (e) {
	...
	aboutUsSection.scrollIntoView({ behavior: 'smooth' }); // Trigger the smooth scroll effect
});

document.getElementById('services-us-link').addEventListener('click', function (e) {
	e.preventDefault(); // Prevent the default behavior of the link

	const ourservicesSection = document.getElementById('our-services');

	ourservicesSection.scrollIntoView({ behavior: 'smooth' }); // Trigger the smooth scroll effect
});
    
  
});

// Assuming your form has an ID "your-form-id"
document.getElementById('your').reset();
